  ...
  return (
    <header>
      ...
      <img
        src={logo}
        alt="Logo"
        style={{ height: "80px", width: "150px", marginRight: "20px" }}
      />
        ...
        <ul>
          ...
          {currentUser ? (
            <>
              ...
              >
                <NavLink to="#">Upper Body ▾</NavLink>
                {upperBodyOpen && (
                  <ul className="dropdown-menu">
                    <li>
                      <NavLink to="/upper-body/abdominal">Abs</NavLink>
                    </li>
                    <li>
                      <NavLink to="/upper-body/arms">Arms</NavLink>
                    </li>
                    <li>
                      <NavLink to="/upper-body/back">Back</NavLink>
                    </li>

                    <li>
                      <NavLink to="/upper-body/chest">Chest</NavLink>
                    </li>
                    <li>
                      <NavLink to="/upper-body/shoulders">Shoulders</NavLink>
                    </li>
              ...
              >
                <NavLink to="#">Lower Body ▾</NavLink>
                {lowerBodyOpen && (
                  <ul className="dropdown-menu">

                    <li>
                      <NavLink to="/lower-body/calves">Calves</NavLink>
                    </li>
                    <li>
                      <NavLink to="/lower-body/hamstrings">Glutes & Hamstrings</NavLink>
                    </li>

                    <li>
                      <NavLink to="/lower-body/Quadriceps">Quads</NavLink>
                    </li>
              ...
              <li>
                <NavLink to="/event-feed">Preview Post</NavLink>
              </li>
              <li>
                <NavLink to="/news">Post Workout</NavLink>
              </li>
              <li>
                <Link to="/AboutUsPage">About Us</Link>
              </li>
              <li>
                <NavLink to="/create-event">Create Post</NavLink>
              </li>
              <li>
